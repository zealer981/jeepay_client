    ...
    <template>
      ...
      >
        <a-row justify="space-between" type="flex">
          ...
          <div class="drawer-btn-center" v-else>
            <a-button :style="{ marginRight: '8px' }" @click="onReject(detailData.orderId)" icon="close">驳回</a-button>
            <a-button type="primary" @click="onAudit(detailData.orderId)" icon="check" :loading="btnLoading">审核通过</a-button>
          </div>
        </a-row>
      </a-drawer>
    </template>
